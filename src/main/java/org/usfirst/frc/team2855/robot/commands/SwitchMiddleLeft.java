...
public class SwitchMiddleLeft extends CommandGroup {
	...
	public SwitchMiddleLeft() {
		addSequential(new AutoTurnLeft(RobotMap.preferences.getDouble("MiddleTurn", 1.0)));
		...
		addSequential(new AutoTurnRight(RobotMap.preferences.getDouble("MiddleTurn2", 1.0)));
